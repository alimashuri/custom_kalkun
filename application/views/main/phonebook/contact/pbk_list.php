...
<div class="two_column_container contact_list" style="display: inline-block;">
	<div class="left_column">
		<div id="pbkname">
		<input type="checkbox" class="select_contact" />&nbsp;<span id="pbk_contactname" style="font-weight: bold;"><?php echo $tmp->Name  ;?></span>
	...
	<div class="right_column">
		...
		<img src="<?php echo $this->config->item('img_path')?>circle.gif" />
		<a class="sendcontact simplelink" href="#"><?php echo lang('tni_contact_send');?></a>
		<img src="<?php echo $this->config->item('img_path')?>circle.gif" />
